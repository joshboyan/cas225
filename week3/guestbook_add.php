...
<!-- 6. Inside the empty quote marks after 'action' below, put the name of the file you are submitting your form to 
(guestbook_add_action.php). -->

<!-- 7. Inside the empty quote marks after 'method' below, insert the correct word for submitting a form. -->
...
<!-- LOOK CAREFULLY at the NAME attribute for each of the form fields below. Those are the *exact* names we will need to use
   on our "action" page. The names are case-sensitive. -->
