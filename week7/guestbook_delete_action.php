...
// 3. When you run this page, you should see the record you selected and the text you entered in
...
//    will have a value. We only want to run the code below if it does *not* have a value.
...
include_once "includes/connection.php";
    ...
    // 7. Create an SQL statement that selects all of the records from the guestbook table where guestbook.id=$id . 
...
include_once "includes/connection.php";
	...
	/* 16. Create an SQL statement that deletes all of the records from the guestbook table where id=$id and a limit of 1 record . 
	HINT: This will be 4 lines of code. See the second DELETE example in Part 1 of this assignment, Step 2. Perform Database Query,
