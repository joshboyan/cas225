...
/* 4. Create an SQL statement that selects username from the users table and orders the results by users.username. Assign the 
...
// After you enter the code above and run the file, you should see your SQL statement displayed.
// Be sure it looks correct before you continue. Note: You will see errors lower on the page
