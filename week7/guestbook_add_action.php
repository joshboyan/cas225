...
// (name of field) and field type from each of them. This way we only have to call each of our functions once!
...
/* 6. Create an SQL INSERT statement that inserts *username* and *comment* into the *guestbook* table. Assign the 
results to $sql. Note: The stars above are just for emphasis. Do not type them.
HINT: This is an INSERT query, NOT a SELECT query. The code should be on 2 lines. See 'Step 2: 
Perform Database Query', c, ii in Part 1 of this assignment for the required format of an INSERT query
